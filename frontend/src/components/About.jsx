...
function About() {
  return (
    <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 pt-24 pb-20 bg-base-100 text-base-content">
      <div className="text-center mb-14">
        <h1 className="text-3xl md:text-5xl font-bold">
          About <span className="text-pink-500">BookStore</span>
        </h1>

        <p className="mt-6 max-w-3xl mx-auto leading-8 text-base-content/80">
      ...
      <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
        <div className="bg-base-200 text-base-content shadow-md rounded-xl p-6 border-t-4 border-pink-500 transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
